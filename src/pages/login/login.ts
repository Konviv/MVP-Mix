...
export class LoginPage {
  ...
  constructor(public navCtrl: NavController, public navParams: NavParams, public http: Http, public appSettings: AppSettingsProvider, public events: Events, private alertCtrl: AlertController) {
    this.user = this.user;
  }
